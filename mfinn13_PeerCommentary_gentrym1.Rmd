---
title: "mfinn13_PeerCommentary_gentrym1"
...
#Matteo: I used three test calls of your function (one upper, one lower, one two-tailed) and compared the results with my function and the results were the same for the one-tailed tests. However, the results were different for the two-tailed test. I think my confidence interval calculation is incorrect.

#Matteo: I also think your output could maybe be formatted a little bit neater. You could use the names() function to give each output a name.
...
#Matteo: Very nice! These are very nice plots and our coefficients were the same. 
```
...
#Matteo: Nice. I agree with your interpretation. 
...
#Matteo: the code to generate the values looks accurate 
...
#Matteo: nice, i did something similar. 
...
#Matteo: I don't really know what's going on here but if it makes a nice plot i'm all for it.
```
...
#Matteo: this does make a very nice plot! I see you used the scale_color_manual to make a legend for your lines. I had tried that but couldn't get it to work. I'm going to see if I can get it to work now.
```
...
```
#Matteo: I got a pretty different value for the estimate and the confidence interval. Not sure why. 
...
# Matteo: I agree with your assessment that the log model is better. 